...
iface1.addMethod(
    ...
    function (n1, n2, callback) {
        console.log('Someone called Add over d-bus')
...
iface1.addMethod(
    'SendVarient',
    { in: [DBus.Define('Auto')], out: DBus.Define('Auto') },
    function (obj, callback) {
        console.log(obj)
        callback(null, obj)
    },
...
iface1.addMethod(
    'GetContacts',
    { out: DBus.Define(Object, 'contacts') },
    function (callback) {
        callback(null, {
            Fred: {
